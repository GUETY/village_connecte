...
function ConnectionChart({ data, chartRef }) {
  ...
  return (
    <div className="bg-white rounded-lg p-4 md:p-5 border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
...
function ForfaitDistributionChart({ forfaitData, chartRef }) {
  const internalRef = chartRef || useRef(null);
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-sm">
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-max divide-y divide-gray-200" role="table" aria-label="Tableau des statistiques">
...
function StatsCards({ totalConnections, peakHour, averageUsers }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 mb-6">
      {/* Total connexions */}
      <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg p-4 md:p-5 border-2 border-indigo-300 shadow-sm hover:shadow-md transition-all duration-300 animate-fadeIn">
      ...
      {/* Heure de pic */}
      <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 md:p-5 border-2 border-orange-300 shadow-sm hover:shadow-md transition-all duration-300 animate-fadeIn" style={{ animationDelay: "100ms" }}>
        <div className="flex items-center justify-between gap-3">
          <div className="flex-1 min-w-0">
      ...
      <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-lg p-4 md:p-5 border-2 border-emerald-300 shadow-sm hover:shadow-md transition-all duration-300 animate-fadeIn sm:col-span-2 lg:col-span-1" style={{ animationDelay: "200ms" }}>
        <div className="flex items-center justify-between gap-3">
          <div className="flex-1 min-w-0">
