...
export default function NavbarAdmin({ children, sidebarOpen = true, onSidebarToggle }) {
    ...
    <div style={{ ["--vc-header-height"]: HEADER_HEIGHT }} className="flex h-screen bg-[var(--vc-bg)] overflow-x-hidden">
      ...
      >
        ...
        <nav className="px-2 py-4 flex-1 flex flex-col gap-1">
          ...
          <NavItem to="/consultation-des-alertes" label="Consultation des alertes" sidebarOpen={open} icon={AlertIcon} />
